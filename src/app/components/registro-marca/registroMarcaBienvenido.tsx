...
const RegistroMarcaBienvenido: React.FC = () => {
  ...
  return (
    <div className="w-full h-full p-8 overflow-y-scroll scrollbar-thin bg-[#070707]">
      <h1 className="text-white text-3xl font-bold flex items-center">
        ¡Bienvenido a la Solicitud de Registro de Marcas en Línea!
      </h1>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-gray-800 rounded-lg w-11/12 md:w-3/4 lg:w-1/2">
            <div className="p-4 border-b border-gray-600 flex justify-between items-center">
              <h2 className="text-white text-xl">¡Bienvenido a la Solicitud de Registro de Marcas en Línea!</h2>
            </div>
          </div>
        </div>
      )}
      <p className="text-white mt-4 mb-4 texto_justificado">
        En esta sección podrás solicitar el registro de tu marca, de forma sencilla, cómoda y además en línea. Las solicitudes de marcas en Panamá se deben presentar a travé de un poder otorgado a un abogado o a una firma de abogados.
      </p>
...
export default RegistroMarcaBienvenido;
