...
const sociedadEmpresaSolicitante: React.FC = () => {
    ...
    return (
        <div className="w-full h-full p-8 overflow-y-scroll scrollbar-thin bg-[#070707]">
            ...
            <p className="text-white mt-4">
                <small>* Aquí se incluye la información de la persona natural que estará en contacto con nosotros para cualquier coordinación y además, que podrá verificar los avances del caso desde el sistema. No tiene que ser el dueño de la sociedad necesariamente.</small>
            </p>
