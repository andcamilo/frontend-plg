...
const ConsultaLegalForm = ({ formData, setFormData, onSubmit, isSubmitting }: any) => (
  <form onSubmit={onSubmit} className="flex flex-col gap-4">
    <label className="font-bold text-white">Consulta Legal - Detalles:</label>
    <input
      type="text"
      name="detalle"
      placeholder="Detalle de la consulta legal"
...
export default ConsultaLegalForm; 