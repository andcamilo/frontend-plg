  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const requestData = {
        ...
        tipo: 'propuesta-legal',
        item: 'Propuesta Legal',
        status: 20,
        precio: 0,
        subtotal: 0,
        total: 0,
      ...
      console.log('[PropuestaLegalForm] Response from create-request-consultaPropuesta:', response.data);
      ...
      console.log('[PropuestaLegalForm] Sending create-record:', recordData);
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label className="font-bold text-white">Nombre completo de a quién va dirigida la Propuesta (persona natural):</label>
          <input
            type="text"
            name="nombreCompleto"
      ...
      {showEmailRespuesta && (
        <div>
          <label className="font-bold text-white">Correo electrónico adicional para envío de propuesta:</label>
          <input
            type="email"
            name="emailRespuesta"
      ...
      <div>
        <label className="font-bold text-white">Si la propuesta va dirigida a una empresa, por favor incluya el nombre:</label>
        <input
          type="text"
          name="empresa"
...
export default PropuestaLegalForm; 