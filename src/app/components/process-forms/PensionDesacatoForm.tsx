...
const PensionDesacatoForm = ({ formData, setFormData, onSubmit, isSubmitting }: any) => (
  <form onSubmit={onSubmit} className="flex flex-col gap-4">
    <label className="font-bold text-white">Pensión Desacato - Detalles:</label>
    <input
      type="text"
      name="detalle"
      placeholder="Detalle de la pensión desacato"
...
export default PensionDesacatoForm; 