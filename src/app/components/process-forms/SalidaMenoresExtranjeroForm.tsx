...
const SalidaMenoresExtranjeroForm = ({ formData, setFormData, onSubmit, isSubmitting }: any) => (
  <form onSubmit={onSubmit} className="flex flex-col gap-4">
    <label className="font-bold text-white">Salida de Menores al Extranjero - Detalles:</label>
    <input
      type="text"
      name="detalle"
      placeholder="Detalle de la salida de menores al extranjero"
