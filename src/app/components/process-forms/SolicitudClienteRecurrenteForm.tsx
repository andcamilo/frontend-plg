...
const SolicitudClienteRecurrenteForm = ({ formData, setFormData, onSubmit, isSubmitting }: any) => (
  <form onSubmit={onSubmit} className="flex flex-col gap-4">
    <label className="font-bold text-white">Solicitud Cliente Recurrente - Detalles:</label>
    <input
      type="text"
      name="detalle"
      placeholder="Detalle de la solicitud cliente recurrente"
...
export default SolicitudClienteRecurrenteForm; 