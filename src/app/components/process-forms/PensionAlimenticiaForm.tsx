...
const PensionAlimenticiaForm = ({ formData, setFormData, onSubmit, isSubmitting }: any) => (
  <form onSubmit={onSubmit} className="flex flex-col gap-4">
    <label className="font-bold text-white">Pensión Alimenticia - Detalles:</label>
    <input
      type="text"
      name="detalle"
      placeholder="Detalle de la pensión alimenticia"
