...
const FaqComponent: React.FC = () => {
    // Estado para controlar la visibilidad de cada pregunta
    const [openQuestion, setOpenQuestion] = useState<number | null>(null);

    // Función para alternar la visibilidad de una pregunta específica
    const toggleQuestion = (questionNumber: number) => {
        // Si ya está abierta, cierra la pregunta; si no, abre esa pregunta
        setOpenQuestion(openQuestion === questionNumber ? null : questionNumber);
    };

    return (
        <DashboardLayout title="Preguntas Frecuentes LEGIX:">
